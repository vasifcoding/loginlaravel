...
<body>
    ...
    <form action="{{route('forget')}}" method="POST">
        ...
        <input type="email" name="email" required placeholder="Email giriniz" id="username">
        
        <label for="password">Yeni Şifre</label>
        <input name="password" type="password" required placeholder="Yeni Şifre giriniz" id="password">
...
<input type="text" required name="securityanswer" placeholder="Guvenlik sorusu cevabi" id="username">
@if($errors->has('login'))
    ...
    @endif
        <button id="login" name="loginuser">Şifreyi Yenile</button>
        <div class="social">
          
          <div class="fb"> <a class="text-decoration-none" href="{{route('register')}}"> Kayıt Ol </a></div>
        </div>
    </form>
